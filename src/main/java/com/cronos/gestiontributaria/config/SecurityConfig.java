 ...
 *
 * <p>
 * Define el codificador BCrypt, el proveedor de autenticación y las rutas
 * públicas, autenticadas y protegidas por rol.
 * </p>
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfig {
        ...
        /**
         * Construye el proveedor de autenticación con el servicio de usuarios y el
         * encoder.
         *
        ...
        public SecurityFilterChain filterChain(HttpSecurity http, DaoAuthenticationProvider authenticationProvider)
                ...
                http.authenticationProvider(authenticationProvider)
                                ...
                                .authorizeHttpRequests(auth -> auth
                                                .requestMatchers("/", "/login", "/registro", "/403", "/css/**",
                                                                "/js/**", "/images/**", "/error",
                                                                "/api/**")
                                                .permitAll()
